...
<section class="menu">
	<nav class="navbar navigation">
		<div class="container">
			...
			<li class="dropdown ">
						<a href="<?= base_url();?>pelanggan">Home</a>
					</li><!-- / Home -->
						...
						<div class='carousel-outer'>
							...
							<div class='carousel-inner '>
								<div class='item active'>
									<img src="<?= base_url('assets/img/' . $p->gambar) ?>" alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
								</div>
		...
		<div class="col-md-7">
				<div class="single-product-details">
					...
					<div class="product-category">
						...
						<ul>
							<li><a href="product-single.html"><?=$p->nama_katagori?></a></li>
							
						</ul>
					</div>
					<a href="<?= base_url();?>pelanggan/datacekout/<?=$p->id_produk;?>" class="btn btn-main mt-20">Add To Cart</a>
				</div>
			</div>
			<?php endforeach;?>
		</div>
			        	...
			        	<div class="row">
			        		...
			        		<div class="col-md-4 col-sm-6 col-xs-12">
			        			<div class="product-short-details">
			        				...
			        				<a href="<?= base_url();?>datacekout" class="btn btn-main">Add To Cart</a>
