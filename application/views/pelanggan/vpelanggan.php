			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-thumb">
						...
						<img class="img-responsive" src="<?= base_url('assets/img/'. $row->gambar )?>" alt="product-img" />
						<div class="preview-meta">
							<ul>
								...
								<li>
									<a href="<?= base_url();?>pelanggan/datacekout/<?=$row->id_produk;?>"><i class="tf-ion-android-cart"></i></a>
								</li>
							</ul>
                      	</div>
					</div>
					<div class="product-content">
						<h4><a href="<?= base_url();?>pelanggan/detailproduk/<?=$row->id_produk;?>"><?=$row->nama_produk?></a></h4>
