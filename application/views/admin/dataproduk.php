	...
	<nav class="navbar navigation">
		<div class="container">
			...
			<ul class="list-inline dashboard-menu text-center">
					...
					<li class="dropdown ">
						<a class="active" href="<?= base_url();?>admin/dataproduk">Data Produk</a>
					</li><!-- / Data Produk -->
...
<section class="user-dashboard page-wrapper">
	<div class="container">
				...
				<div class="dashboard-wrapper user-dashboard">
					...
					<a href="tambahproduk" class="btn btn-success">tambah data </a>
						<h4>Data Produk</h4>
						<div class="table-responsive">
							<table class="table">
								...
								<?php foreach ($produk as $row):?>
										...
										<td><img style="width: 50px; height:50px;"src="<?= base_url('assets/img/' . $row->gambar) ?>">
									</td>
										
										<td><a href="editproduk/<?=$row->id_produk?>" class="btn btn-primary">edit</a>
										<a href="hapusproduk/<?=$row->id_produk?>" onclick="return(confirm ('apakah anda yakin menghapus?'))" class="btn btn-danger">hapus</a>
										</td>
									</tr>
									<?php endforeach ?>
