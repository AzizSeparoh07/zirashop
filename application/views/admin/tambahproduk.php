			...
			<div class="col-md-12">
				...
				<div class="dashboard-wrapper user-dashboard">
					...
					<div class="total-order mt-20">
						...
						<form class="user" action="<?php echo base_url('admin/prosesProduk'); ?>" enctype="multipart/form-data" enctype="multipart/form-data" method="post">
                            <div class="form-group">
								...
								<select  name="id_katagori" class="form-control" required>
                                                <option value="" readonly>Select katagori</option>
                                                <?php foreach ($katagori as $row) : ?>
                                                    <option value="<?= $row->id_katagori; ?>"><?= $row->nama_katagori; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                </div>
                                <div class="form-group">
