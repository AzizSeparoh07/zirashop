		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse text-center">
				<ul class="list-inline dashboard-menu text-center">
					...
					<li class="dropdown ">
						<a class="active" href="<?= base_url();?>admin/datakatagori">Data Katagori</a>
					</li><!-- / Data Katagori -->
					<li class="dropdown ">
						<a href="<?= base_url();?>admin/dataproduk">Data Produk</a>
					</li><!-- / Data Produk -->
					<li class="dropdown ">
						<a href="<?= base_url();?>admin/datainput">Input Produk</a>
					</li><!-- / Input Produk -->
					<li class="dropdown ">
			...
			<div class="col-md-12">
				...
				<div class="dashboard-wrapper user-dashboard">
					...
					<div class="total-order mt-20">
						...
						<h4>Edit Data Katagori</h4>
						<div class="table-responsive">
						<form class="user" action="<?php echo base_url('admin/proseseditkatagori'); ?>" method="post">
						<input type="hidden" name="id_katagori" value="<?=$katagori['id_katagori'];?>">
                            <div class="form-group">

                                    <input type="text" class="form-control form-control-user" name="nama_katagori"
                                        value="<?php echo $katagori['nama_katagori'];?>">
                                </div>
