	...
	<nav class="navbar navigation">
		<div class="container">
			...
			<ul class="list-inline dashboard-menu text-center">
					...
					<li class="dropdown ">
						<a class="active" href="<?= base_url();?>admin/datalaporan">Data Laporan</a>
					</li><!-- / Data Laporan -->
							...
							<table class="table">
								...
								<?php foreach ($laporan as $row):?>
										...
										<?=$row->nama_laporan?></td>
											...
											<td><?=$row->email?></td>
											<td><?=$row->alamat?></td>
										<td><a href="editlaporan/<?=$row->id_laporan?>" class="btn btn-primary">edit</a>
										<a href="hapuslaporan/<?=$row->id_laporan?>" onclick="return(confirm ('apakah anda yakin menghapus?'))" class="btn btn-danger">hapus</a>
										</td>
									</tr>
									<?php endforeach ?>
