			...
			<div class="col-md-12">
				...
				<div class="dashboard-wrapper user-dashboard">
					...
					<div class="total-order mt-20">
						<h4>Total Orders</h4>
						<a href="tambahkatagori" class="btn btn-success">tambah data </a>
						<h4>Data Katagori</h4>
							...
							<table class="table">
								...
								<tbody>
									...
									<?php foreach ($katagori as $row):?>
										...
										<td></td>
										<td><a href="editkatagori/<?=$row->id_katagori?>" class="btn btn-primary">edit</a>
										<a href="hapuskatagori/<?=$row->id_katagori?>" onclick="return(confirm ('apakah anda yakin menghapus?'))" class="btn btn-danger">hapus</a>
									</td>
									</tr>
