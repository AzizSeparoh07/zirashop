			...
			<div class="col-md-12">
				...
				<div class="dashboard-wrapper user-dashboard">
					...
					<div class="total-order mt-20">
						<h4>Total Orders</h4>
						<a href="tambahtransaksi" class="btn btn-success">tambah data </a>
							...
							<table class="table">
								...
								<?php foreach ($transaksi as $row):?>
										...
										<td><?=$row->nama_pelanggan?></td>
											<td><?=$row->tanggal_oder?></td>
											<td><?=$row->total_bayar?></td>
											<td><?=$row->bukti_pembayaran?></td>
											<td><?=$row->atas_nama?></td>
											<td><?=$row->status?></td>
										<td><a href="edittransaksi/<?php echo $row->id_transaksi?>" class="btn btn-primary">edit</a>
										<a href="hapustransaksi/<?=$row->id_transaksi?>" onclick="return(confirm ('apakah anda yakin menghapus?'))" class="btn btn-danger">hapus</a>
										</td>
									</tr>
									<?php endforeach ?>
									</tbody>
